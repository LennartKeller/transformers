...
model = RobertaForSequenceClassification.from_pretrained("uklfr/gottbert-base", num_labels=9)
...
training_args = TrainingArguments(
    num_train_epochs=3,
    output_dir="test_runs/run/pyramid_classif_gnad10_baseline",
    logging_dir="test_runs/logs/pyramid_classif_gnad10_baseline",
